...
class CourierAd(models.Model):
    ...
    courier = models.ForeignKey(Profile, on_delete=models.PROTECT)
    ...
    package_length = models.FloatField(verbose_name="Maximum length of longest side: ")
    package_price_min = models.FloatField(verbose_name="Price minimum: ")
...
class PackageAd(models.Model):
    ...
    package_price_max = models.FloatField(verbose_name="Price maximum: ")
    package_price_cur = models.CharField(max_length=3, verbose_name="3-digit currency code: ")
